    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="relative">
                        <input type="text" id="patientsSearchInput" placeholder="Buscar por nombre, apellido o cédula..." 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Primera Visita</th>
                            ...
                            <tbody id="patientsTableBody" class="bg-white divide-y divide-gray-200">
                                @forelse($patients as $patient)
                                    <tr data-patient-id="{{ $patient->id }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $patient->created_at->format('d/m/Y h:i A') }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $patient->updated_at->format('d/m/Y h:i A') }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex gap-2">
                                                ...
                                                <a href="{{ route('patients.print-double', $patient->id) }}" 
                                                    class="inline-flex items-center px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium rounded-md transition-colors duration-150" 
                                                    title="Imprimir 2 copias en una hoja">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
